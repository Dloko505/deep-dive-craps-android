package edu.cnm.deepdive.dloko505.craps;
...
public class MainActivity extends AppCompatActivity {
  ...
  private Random rng;
  private RollsAdaptor rollsAdaptor;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    rollsAdaptor = new RollsAdaptor(this, R.layout.item_roll);
    rolls.setAdapter(rollsAdaptor);
    reset();
  ...
  private void updateDisplay(State state, Roll[] rolls, long plays, long wins) {
    ...
    rollsAdaptor.clear();
    rollsAdaptor.setState(state);
    if (rolls != null) {
      rollsAdaptor.addAll(rolls);
    }
  }
